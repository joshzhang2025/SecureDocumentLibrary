...
def main() -> None:
    ...
    get_command = commands.add_parser("retrieve"); get_command.add_argument("document_id"); get_command.add_argument("--index", required=True, type=Path); get_command.add_argument("--authorized-source", action="append", default=[])
    ...
    else: print(retrieve(args.index, args.document_id, set(args.authorized_source)))
